...
class PatientsReader:
    def __init__(self, now, url='https://www.pref.hiroshima.lg.jp/site/hcdc/covid19-kanjya.html'):
         #2020.5.12修正 URLが変わったため 修正前は、https://www.pref.hiroshima.lg.jp/soshiki/57/bukan-coronavirus.html'
